    ...
    <section id="testimonials" class="testimonials">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
           <h4>L3 BUSSINESS DESCRIPTION</h4>
        </div>
...
try{
  ...
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L3' and trade='BUSSINESS'");
  $a->execute();
   ...
   ?>
    ...
    <section id="testimonials" class="testimonials">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h4>L4 BUSSINESS DESCRIPTION</h4>
        </div>
...
try{
  include("code/connection.php");
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L4' and trade='BUSSINESS'");
  $a->execute();
  while($row=$a->fetch(PDO::FETCH_ASSOC)){ ?>
  ...
  <?php
   ...
   ?>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
           <h4>L5 BUSSINESS DESCRIPTION</h4>
        </div>
...
try{
  include("code/connection.php");
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L5' and trade='BUSSINESS'");
  $a->execute();
  while($row=$a->fetch(PDO::FETCH_ASSOC)){ ?>
