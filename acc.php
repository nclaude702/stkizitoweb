...
try{
  ...
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L3' and trade='ACCOUNTING'");
  $a->execute();
...
try{
  include("code/connection.php");
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L4' and trade='ACCOUNTING'");
  $a->execute();
  while($row=$a->fetch(PDO::FETCH_ASSOC)){ ?>
...
try{
  include("code/connection.php");
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L5' and trade='ACCOUNTING'");
  $a->execute();
  while($row=$a->fetch(PDO::FETCH_ASSOC)){ ?>
