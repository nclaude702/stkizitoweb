      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>SAINT KIZITO SAVE TVET SCHOOL IN MULTIMEDIA</h3>
...
try{
  ...
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L4' and trade='MULTIMEDIA'");
  $a->execute();
...
try{
  include("code/connection.php");
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L5' and trade='MULTIMEDIA'");
  $a->execute();
  while($row=$a->fetch(PDO::FETCH_ASSOC)){ ?>
