    ...
    <section id="testimonials" class="testimonials">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
           <h4>L3 DOMESTIC ELECTRICITY DESCRIPTION</h4>
        </div>
...
try{
  ...
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L3' and trade='DOMESTIC ELECTRICITY'");
  $a->execute();
   ...
   ?>
    ...
    <section id="testimonials" class="testimonials">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h4>L4 INDUSTRIAL ELECTRICITY DESCRIPTION</h4>
        </div>
...
try{
  include("code/connection.php");
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L4' and trade='INDUSTRIAL ELECTRICITY'");
  $a->execute();
  while($row=$a->fetch(PDO::FETCH_ASSOC)){ ?>
         ...
         <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="" class="<img src="" class="testimonial-img" alt="">
                  <h3>Trainer:<?php echo $row['trainer']; ?></h3>
                  <h4></h4>
                  <p>
                   Module Name:<?php echo $row['book_title']."<br>". $row['book']."<br>". $row['level']."  ". $row['trade']; ?>"
  ...
  <?php
   ...
   ?>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
           <h4>L5 INDUSTRIAL ELECTRICITY DESCRIPTION</h4>
        </div>
...
try{
  include("code/connection.php");
  $a=$con->prepare("SELECT * FROM `book` WHERE level='L5' and trade='INDUSTRIAL ELECTRICITY'");
  $a->execute();
  while($row=$a->fetch(PDO::FETCH_ASSOC)){ ?>
